...
const Edit = _ref => {
  ...
  function onFileSelect(imgObj) {
    setAttributes({
      imageURL: imgObj.sizes.full.url
    });
  }
...
/* harmony import */ var _Edit__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Edit */ "./blocks/hero/Edit.js");




(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_2__.registerBlockType)('sapphiretheme/hero', {
  title: 'Sapphire Hero',
  attributes: {
    image: {
      type: 'string',
